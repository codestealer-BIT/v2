...
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_bm_filtering_41m_gt8"  # CHANGE
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    --model_name video_siglip2_for_music_negative_filtering_by_bm \
