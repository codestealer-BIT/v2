...
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/wangxiuqi.0601/checkpoints/video_siglip2_for_music_1029_dis_all_lang_new_gate_v2_60m_gt7_rescale_05_filter_same_meta_prob_05_test"
...
torchrun --nnodes=1 \
    ...
    --filter_same_meta_prob 1.0 \
    --score_3_sample_rate 0.5 \
