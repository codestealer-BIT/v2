...
PRETRAINED_PATH="/mnt/bn/jiny-ttls-i18n-fr1q/wangxiuqi.0601/checkpoints/only_match_50m_huber_05_v3/checkpoint-50000"
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/wangxiuqi.0601/checkpoints/only_match_50m_huber_05_v3_continue_lr_1e-5_only_pairwise"
...
torchrun --nnodes=1 \
	...
	--nproc_per_node ${ARNOLD_WORKER_GPU} \
    train/train_video_siglip2_for_music_rec_pairwise.py \
    --model_name video_siglip2_for_music_only_match_pairwise \
