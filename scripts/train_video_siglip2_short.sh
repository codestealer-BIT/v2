...
OUTPUT_DIR="/mnt/bn/yexiaoyu-test/checkpoints/stage_1_internvid_occupy"

BATCH_SIZE=64
GRAD_ACCU_STEPS=1
NUM_FRAMES=8
#ANNO_FILE="hdfs://harunasg/home/byte_data_tt_m/jinyang.leo/music_rec_data/finetune_v1_data_plus"
ANNO_FILE="/mnt/bn/jiny-ttls-i18n-fr1q/vd-foundation___InternVid-10M-FLT/intervid_anno/InternVid-10M-FLT-INFO_with_path.jsonl"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    train/train_video_siglip2_short.py \
