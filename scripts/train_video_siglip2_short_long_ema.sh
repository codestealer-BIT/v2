...
OUTPUT_DIR="/mnt/bn/yexiaoyu-test/checkpoints/stage_1_mix_training_ema"
PRETRAINED_PATH="/mnt/bn/yexiaoyu-test/checkpoints/stage_1_mix_training_interpolate_6/checkpoint-126000"

BATCH_SIZE=32
GRAD_ACCU_STEPS=1
NUM_FRAMES=8

HDFS_FILE="hdfs://harunasg/home/byte_data_tt_m/jinyang.leo/music_rec_data/finetune_v1_data_plus"
HDFS_DICT_FILE="/mnt/bn/jiny-ttls-i18n-fr1q/synth_captions_for_small_model"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
	--node_rank ${ARNOLD_ID}  --master_addr ${METIS_WORKER_0_HOST} --master_port ${METIS_WORKER_0_PORT} \
	--nproc_per_node ${ARNOLD_WORKER_GPU} \
    train/train_video_siglip2_short_long_ema.py \
