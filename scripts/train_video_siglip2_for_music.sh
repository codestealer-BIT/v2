...
# OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/checkpoints/video_siglip2_for_music_baseline"
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_41m_new"
...
ANNO_FILE='/mnt/bn/jiny-ttls-i18n-fr1q/lutong/data/llm_judge_pretrain_data_pgc_1023_28m_w_user_lang.json'
# ANNO_FILE="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/data/llm_judge_pretrain_data_pgc_1023_41m_new.json"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    --model_name video_siglip2_for_music \
