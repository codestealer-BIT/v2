...
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_1029_dis_add_user_info_residual_61m_gt7_title"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    --model_name video_siglip2_for_music_negative_filtering_add_user_info \
