...
# OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_1029_dis_add_user_info_gate_60m_gt7_panel_capsule_slideshow" # exp1, done
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_1029_dis_add_user_info_gate_60m_gt7_panel_capsule_slideshow_from_148000"  #exp3, change to 100 epochs
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    --model_name video_siglip2_for_music_negative_filtering_add_lang_multi \
    --model_path $MODEL_PATH \
    --pretrained_path $PRETRAINED_PATH \
    --historical_model_path $HISTORICAL_MODEL_PATH \
    --historical_score_threshold 0.1 \
    --user_info_fusion_method gate \
    --allowed_music_selected_from edit_page_recommend,video_capsule_recommend,slideshow_rec \
    --model_dtype bf16 \
    --interpolate 6 \
    --max_short_len 64 \
