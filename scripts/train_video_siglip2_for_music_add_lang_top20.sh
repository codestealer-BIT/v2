...
OUTPUT_DIR="/mnt/bn/jiny-ttls-i18n-fr1q/lutong/checkpoints/video_siglip2_for_music_bm_add_user_info_residual_61m_gt8_title_multi_lang_loss"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
    ...
    --model_name video_siglip2_for_music_negative_filtering_by_bm_add_user_info \
    ...
    --use_frame_mask 2>error_${ARNOLD_ID}.log
