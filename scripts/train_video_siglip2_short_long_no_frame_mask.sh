...
OUTPUT_DIR="/mnt/bn/yexiaoyu-test/checkpoints/stage_1_final_no_frame_mask"
#PRETRAINED_PATH="/mnt/bn/yexiaoyu-test/checkpoints/stage_1_internvid_aug_freeze_text/checkpoint-48000"
...
torchrun --nnodes=${ARNOLD_WORKER_NUM} \
	--node_rank ${ARNOLD_ID}  --master_addr ${METIS_WORKER_0_HOST} --master_port ${METIS_WORKER_0_PORT} \
	--nproc_per_node ${ARNOLD_WORKER_GPU} \
    train/train_video_siglip2_short_long.py \
