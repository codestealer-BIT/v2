...
def init_model(args, device, n_gpu, local_rank):
    ...
    model = Siglip2Model.from_pretrained(args.pretrained_config)
...
def eval_epoch(args, model, test_dataloader, device, n_gpu):
    ...
    with torch.no_grad():
        ...
        for bid, batch in enumerate(test_dataloader):
            ...
            text_input_ids, pixel_values, pixel_attention_mask, spatial_shapes = batch
            ...
            if multi_sentence_:
                ...
                sequence_output = model.text_model(input_ids=text_input_ids).pooler_output
                ...
                if len(filter_inds) > 0:
                    ...
                    visual_output = vis_feat = model.vision_model(
                        pixel_values=pixel_values,
                        attention_mask=pixel_attention_mask,
                        spatial_shapes=spatial_shapes).pooler_output
                    batch_visual_output_list.append(visual_output.view(B,F,hidden_size).mean(dim=1))
