...
class Siglip2VisionTower(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, Siglip2VisionTower

        >>> model = Siglip2VisionTower.from_pretrained("google/siglip2-base-patch16-224")
...
class Siglip2Model(Siglip2PreTrainedModel):
    ...
    def __init__(self, config: Siglip2Config):
        ...
        text_model = Siglip2TextTower._from_config(text_config)
        vision_model = Siglip2VisionTower._from_config(vision_config)
    ...
    def get_text_features(
        ...
        Returns:
            ...
            applying the projection layer to the pooled output of [`Siglip2TextTower`].
    ...
    def get_image_features(
        ...
        Returns:
            ...
            applying the projection layer to the pooled output of [`Siglip2VisionTower`].
...
class Siglip2ForImageClassification(Siglip2PreTrainedModel):
    ...
    def __init__(self, config: Siglip2Config) -> None:
        ...
        vision_model = Siglip2VisionTower._from_config(config.vision_config)
        self.vision_model = vision_model.vision_model
