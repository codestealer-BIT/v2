...
def get_args():
    ...
    parser.add_argument('--max_text_len',default=64, type=int, help='number of text tokens')
    parser.add_argument('--anno_file_path', default='', type=str, help="The annotation HDFS remote path")
    parser.add_argument('--dict_path', default='/mnt/bn/jiny-ttls-i18n-fr1q/synth_captions_for_small_model', type=str, help="The caption path")
...
def main(args):
    ...
    train_dataset = VideoDatasetInternVid(
        anno_file_path,
        rank=global_rank,
