...
from video_clip import VideoSigLIP2ShortLongEMA
...
def build_model_runner(args, queue_size):
    ...
    runner = VideoSigLIP2ShortLongEMA(
        model_path,
        gpuwise_nce=False,
...
def main(args):
    ...
    train_dataset = VideoDatasetMixture(datasets = [hdfs_dataset, internvid_dataset],weights = [0.5,0.5])
