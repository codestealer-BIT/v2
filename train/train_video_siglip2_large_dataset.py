...
from dataset import (
    VideoHDFSDatasetLarrge,
    create_mm_embed_dataloader,
)

from video_clip import VideoSigLIP2Temporal
...
def get_args():
    ...
    parser.add_argument('--anno_file_path', nargs='+', default=[], help="The annotation HDFS remote path")
...
def main(args):
    ...
    args.anno_file_path = anno_file_path[0]

    train_dataset = VideoHDFSDatasetLarge(
        anno_file_path,
