...
from video_clip import VideoSigLIP2TemporalFusion, VideoSigLIP2Temporal
...
def get_args():
    ...
    parser.add_argument('--bert_path',default="", type=str, help='the bert tokenizer')
    ...
    parser.add_argument('--max_text_len',default=256, type=int, help='number of text tokens')
    ...
    parser.add_argument('--vision_encoder_lr', type=float, default=2e-5, metavar='LR',
                        help='vision encoder learning rate (default: 2e-5)')
...
def build_model_runner(args, queue_size):
    ...
    runner = VideoSigLIP2TemporalFusion(
        model_path,
    ...
    if args.pretrained_path:
        ...
        runner.load_state_dict(torch.load(args.pretrained_path + '/pytorch_model.bin'),strict = False)
        ...
        runner.text_decoder.load_state_dict(runner.text_tower.text_model.state_dict(),strict = False)
...
def main(args):
    ...
    train_dataset = VideoHDFSDatasetFusion(
        anno_file_path,
