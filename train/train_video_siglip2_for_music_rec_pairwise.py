...
from dataset import (
    VideoMusicPairwiseHDFSDataset,
    create_mm_embed_dataloader,
)

from video_clip import VideoSigLIP2ForMusicOnlyMatchingPairwise
...
def build_model_runner(args, queue_size):
    ...
    if args.model_name == 'video_siglip2_for_music_only_match_pairwise':
        runner = VideoSigLIP2ForMusicOnlyMatchingPairwise(
            model_path,
            gpuwise_nce=True,
...
def main(args):
    ...
    train_dataset = VideoMusicPairwiseHDFSDataset(
        anno_file_path,
        rank=global_rank,
