...
from video_clip import VideoSigLIP2TemporalFusionBLIP, VideoSigLIP2Temporal
...
def build_model_runner(args, queue_size):
    ...
    runner = VideoSigLIP2TemporalFusionBLIP(
        model_path,
...
def main(args):
    ...
    train_dataset = VideoHDFSDatasetFusionBLIP(
        anno_file_path,
