...
from video_clip import VideoSigLIP2TemporalLong
...
def get_args():
    ...
    parser.add_argument('--max_text_len', default=64, type=int, help='number of max text tokens')
...
def build_model_runner(args, queue_size):
    ...
    runner = VideoSigLIP2TemporalLong(
        model_path,
        args.load_vision,
        args.load_text,
        gpuwise_nce=False,
