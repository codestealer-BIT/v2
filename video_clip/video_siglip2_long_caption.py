...
try:
    from .siglip2_temporal_long_caption import *
except:
    from siglip2_temporal_long_caption import *
...
class VideoSigLIP2TemporalLong(torch.nn.Module):
    def __init__(self,
                 model_path,
    ...
    def init_modules(self, model_path, load_vision=True, load_text=True):
        ...
        if(load_text):
            ...
            #initialize positional_embedding
            ...
            self.text_tower.text_model.embeddings.position_embedding_o.weight.data = posisitonal_embedding_new

            self.text_tower.text_model.embeddings.position_embedding_n.weight.data = positional_embedding_res
...
if __name__ == "__main__":
    ...
    videosig = VideoSigLIP2TemporalLong(model_path = model_path, gpuwise_nce = False)
    ...
    text_inputs = tokenizer(text, padding="max_length", max_length = 196, return_tensors="pt")
