...
class VideoSigLIP2ForMusicOnlyMatching(torch.nn.Module):
    def __init__(self,
                 model_path,
    ...
    def calc_regression_loss(self, image_embeds, music_embeds, label):
        ...
        return loss, pred_score, self.logit_scale, self.logit_bias
    ...
    def forward(
        ...
        video_music_matching_loss, pred_score, scale, bias = self.calc_regression_loss(cls_visual_embedding, music_embedding, video_music_match_labels)
