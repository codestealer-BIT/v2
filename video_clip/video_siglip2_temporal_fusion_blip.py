...
try:
    from .siglip2_temporal_fusion_blip import *
except:
    from siglip2_temporal_fusion_blip import *
...
class VideoSigLIP2TemporalFusionBLIP(torch.nn.Module):
    def __init__(self,
                 model_path,
                 blip_path,
    ...
    def forward(
        ...
        blip_input_ids = samples['blip_input_ids']
        blip_attention_mask = samples['blip_attention_mask']#在text encoder的时候不要传
        ...
        ret_dict['video_text_loss'] = video_caption_loss
        ...
        ret_dict['fused_text_loss'] = fused_caption_loss
